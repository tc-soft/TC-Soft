...
import picture09 from'./09.png';

function Instruction03() {
    return (
        <React.Fragment>
            <section className="instructionDetail">

                <h3>Konfiguracja konta Exchange na telefonach z systemem iOS</h3>

                <p>
                    Dokument opisuje sposób konfiguracji konta pocztowego Exchange na telefonach komórkowych z system iOS.
                </p>
                ...
                <ul className="instructionDetail__mainPoint">
                    ...
                    <li>
                        Pobieramy oraz instalujemy za pomocą App Store aplikację Microsoft Outlook - ikonka jak na rysunku poniżej. 
                        Należy mieć aktywne konto usługi AppleID oraz dostęp do internetu.
                        <img  src={picture01} style={{ width: "30%", height: "30%" }} alt="picture01"/>
                    </li>
                    <li>
                    ...
                    <li>
                        Zapoznaj się z funkcjami i rozpocznij korzystanie z aplikacji Outlook dla iOS
                    ...
                    <li>
                        ...
                        <img  src={picture07} style={{ width: "30%", height: "30%" }} alt="picture07"/>
                        <img  src={picture08} alt="picture08"/>
                        <img  src={picture09} alt="picture09"/>
                    </li>
                    <li>
